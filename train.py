...
parser.add_argument('--modelsSavePath', type=str, default='./results/models/', help='path for saving models')
...
parser.add_argument('--dataRoot', type=str, default='./dehw_testA_dataset/dehw_testA_dataset/images')
parser.add_argument('--pretrained',type=str, default='./STE_str_best.pdparams', help='pretrained models for finetuning')
